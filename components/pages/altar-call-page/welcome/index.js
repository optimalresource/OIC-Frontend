...
const Welcome = () => {
  return (
    <div className="flex flex-col gap-2 w-[750px] max1040:w-[90%] max1040:mt-[100px] my-[100px] shadow-[0_26px_44px_rgba(189,189,189,0.25)] rounded-[30px] p-[70px] mx-[auto] bmd:p-[30px] max400:px-[20px]">
      <h1 className="capitalize text-4xl bmd:text-3xl text-center font-semibold text-[#1f4477] mb-5">
        A new beginning...
      </h1>
      <p className="py-1">
