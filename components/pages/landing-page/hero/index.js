...
const Hero = ({ header }) => {
  const classNa =
    "w-[100%] relative my-5 bg-[url('/assets/images/hero/squared/1.png'})]";
  return (
    <div className="flex justify-center items-center w-[90%] bmd:w-[100%] mt-[150px] max640:mt-[100px] relative">
      <div className="w-[100%] relative my-5 bg-[url('/assets/images/hero/squared/1.png')] bg-cover md:rounded-[50px]">
        <div className="px-5 md:px-10 text-[#fff] top-0 left-0 h-[100%] w-[100%] flex flex-col items-center justify-center max400:px-2">
          <div className="flex-1 pl-2 md:pl-7 lg:pl-12 pr-2 lg:pr-5 max400:pr-1 max400:pl-1 max320:px-0 text-center py-10">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-20 max400:text-2xl max400:leading-10">
